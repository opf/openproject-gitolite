module Grack
  class Server
    ...
    def capture(command)
      ...
      begin
        OpenProject::Gitolite::Utils::Exec.capture(cmd, args)
      rescue => e
    ...
    private
      ...
      def gitolite_path(path)
        File.join(OpenProject::Gitolite::Config.gitolite_global_storage_dir, OpenProject::Gitolite::Config.gitolite_redmine_storage_dir, path)
      end


      def directory_exists?(dir)
        OpenProject::Gitolite::Commands.sudo_dir_exists?(dir)
      end
      ...
      def git_command_without_chdir
        OpenProject::Gitolite::Commands.sudo_git_cmd(smart_http_args)
      end


      def git_command_with_chdir
        OpenProject::Gitolite::Commands.sudo_git_args_for_repo(@dir, smart_http_args)
      end
      ...
      def smart_http_args
        [
          'env',
          "GL_LIBDIR=#{OpenProject::Gitolite::Config.gitolite_lib_dir_path}",
