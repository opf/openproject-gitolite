  ...
  class Git
    ...
    private
      ...
      def git_command_with_chdir
        OpenProject::Gitolite::Commands.sudo_git_args_for_repo(@repo, smart_http_args)
      end
      ...
      def smart_http_args
        [
          'env',
          "GL_BINDIR=#{OpenProject::Gitolite::Config.gitolite_bin_dir}",
          "GL_LIBDIR=#{OpenProject::Gitolite::Config.gitolite_lib_dir}",
