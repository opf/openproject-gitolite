module OpenProject::Gitolite
  class GitoliteHook
    ...
    private
      ...
      def force_update?
        OpenProject::Gitolite::Config.gitolite_overwrite_existing_hooks?
      end
      ...
      def file_exists?
        OpenProject::Gitolite::Commands.sudo_file_exists?(destination_path)
      end
      ...
      def update_gitolite
        OpenProject::Gitolite::Commands.sudo_update_gitolite!
      end


      def gitolite_hooks_dir
        OpenProject::Gitolite::Config.gitolite_hooks_dir
      end


      def directory_exists?
        OpenProject::Gitolite::Commands.sudo_dir_exists?(parent_path)
      end
      ...
      def create_parent_dir
        ...
        begin
          OpenProject::Gitolite::Commands.sudo_mkdir_p(parent_path)
          return true
