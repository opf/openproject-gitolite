...
module OpenProject::Gitolite::GitoliteWrapper
  module RepositoriesHelper
    def handle_repository_add(repository)
      ...
      builder = OpenProject::Gitolite::GitoliteWrapper::PermissionBuilder.new repository
    ...
    def move_physical_repo(old_path, old_name, new_path, new_name, force_move)
      ...
      if !File.directory?(parent_dir)
        ...
        begin
          OpenProject::Gitolite::Commands.sudo_mkdir_p(parent_dir.to_s)
          OpenProject::Gitolite::Commands.sudo_chmod('770', parent_dir.to_s)
    ...
    def clean_repo_dir(path)
      repo_root = OpenProject::Gitolite::GitoliteWrapper.gitolite_global_storage_path
      ...
      Dir.chdir(repo_root) do
        ...
        if File.directory?(full_path)
          ...
          OpenProject::Gitolite::Commands.sudo_rm_rf(full_path) #To prevent error while deleting repos that use SmartHTTP (still need to find why error is produced)
