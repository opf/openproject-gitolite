module OpenProject::Gitolite::GitoliteWrapper
  class Projects < Admin
    ...
    def clear_gitolite_config
      @admin.transaction do
        gitolite_admin_dir = OpenProject::Gitolite::Config.get_setting(:gitolite_admin_dir)
        config_file = OpenProject::Gitolite::GitoliteWrapper.gitolite_admin_settings[:config_file]
