OpenProject::Gitolite::GitoliteHooks.register_hooks do
  # Set source dir
  source_dir    File.join(Gem.loaded_specs['openproject-gitolite'].full_gem_path.to_s, 'contrib', 'hooks').to_s
...
#
# *OpenProject::Gitolite::GitoliteHooks.register_hooks* can be called multiple times
