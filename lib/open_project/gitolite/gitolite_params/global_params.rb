module OpenProject::Gitolite
  module GitoliteParams
    class GlobalParams
      ...
      def initialize
        # Params to set
        @gitolite_hooks_url = OpenProject::Gitolite::Config.gitolite_hooks_url
        @debug_mode         = OpenProject::Gitolite::Config.gitolite_hooks_debug.to_s
        @async_mode         = OpenProject::Gitolite::Config.gitolite_hooks_are_asynchronous.to_s

        # Namespace where to set params
        @namespace = OpenProject::Gitolite::Config.gitolite_hooks_namespace
